...
Here's a nice little breadcrumbs function I made in one of my apps. When you define an application wide pattern and organize things properly you can pull off otherwise complicated features in a simple manner:
  ...
  def breadcrumbs
    ...
    contexts_url_parts.each do |url_part|
      ...
      crumbs << link_to(text, smart_path(*url_parts))
    end
    crumbs
  end
